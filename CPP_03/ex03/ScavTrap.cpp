...
/*   Updated: 2021/05/04 16:01:31 by aduregon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(std::string n) : ClapTrap(n)
{
	...
	this->armorDamageReduction = 3;
	this->level = 1;
	std::cout << "\033[1m\033[33m***** SCAVTRAP *****\033[0m" << std::endl;
...
void				ScavTrap::challengeNewcomer(std::string const & target)
{
	...
	std::cout << "\033[1m\033[35mSC4V-T " << this->name << challenge[rand() % 5] << target << damage[rand() % 5] << "\033[0m" << std::endl;
}